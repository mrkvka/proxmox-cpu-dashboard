...
for f in pve_hw_core.js pve_hw_tab.js pve_hw_guests.js pve_hw_plugin.js pve_hw_build_info.js; do
...
check "guests source" "test -f /usr/share/pve-node-hw-ui/ui/pve_hw_guests.js"
